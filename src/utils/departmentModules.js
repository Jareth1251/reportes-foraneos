...
export const MODULE_DEFS = {
  ...
  'reporte-maestro':        { key: 'reporte-maestro',        icon: '🗂️', label: 'Reporte Maestro',           desc: 'Une checkins, foráneos y página web en una sola tabla: área, error y clasificación por pedido.', color: '#334155', bg: '#F1F5F9', border: '#CBD5E1' },
